    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> AddImage(PropertyImageViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                _datacontext.GetPropertyImages.Add(propertyImage);
                await _datacontext.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteImage(int? id)
        {
            ...
            var propertyImage = await _datacontext.GetPropertyImages
            ...
            _datacontext.GetPropertyImages.Remove(propertyImage);
            await _datacontext.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteProperty(int? id)
        {
            ...
            _datacontext.GetPropertyImages.RemoveRange(property.PropertyImages);
